...
from util import create_primes
...
class LaunchWindow(QWidget):
    ...
    def initUI(self):
        ...
        self.appendButton.setIcon(QIcon(dirpath+'/../image/view.png'))
        ...
        self.viewButton.setIcon(QIcon(dirpath+'/../image/view.png'))
        self.viewButton.clicked.connect(self.onView)

        self.saveButton = QPushButton('保存')
        self.saveButton.setIcon(QIcon(dirpath+'/../image/save.png'))
        ...
        self.setWindowIcon(QIcon(dirpath+'/../image/launch.png'))
    ...
    def onSave(self):
        if self.Check() == True:
            ...
            if reply == QMessageBox.Yes:
                ...
                captcha = md5(s)
                with open(dirpath + "/../invitation.txt", "a") as f:
                    f.write(title+' '+captcha+'\n')
                ...
                write_log_to_Text('用户' + self.usr + '发起投票成功  '+'标题：'+title+' 邀请码：'+captcha)
                if flag == 0:
